...
3] Go inside the emartfolder 
4] Read Docker compose.yml file 
5] Run the docker compose using, "docker compose up" command and hence we have deployed an microservices applcation on containers using Vagrantfile.
